...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button viber_bt = findViewById(R.id.IDC_VIBERTEST_BT);
        viber_bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent("com.xbase.viber.test");
                sendBroadcast(intent);
            }
        });


        Button wa_bt = findViewById(R.id.IDC_WA_TEST);
        wa_bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent("com.xbase.wa.test");
                sendBroadcast(intent);
            }
        });


        Button line_bt = findViewById(R.id.IDC_LINETEST_BT);
        line_bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent("com.xbase.wa.line");
                sendBroadcast(intent);
            }
        });
